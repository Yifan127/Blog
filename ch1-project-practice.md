...
* **Reading Unicode File**
    ...
    * 3 ways to read a file:
         ...
         **Summary 1**: Use **readlines()** to get a list, each line in the file is an element in the list. Although **readline()** is not very efficiency, but is useful when the when the file is realy **big**, like 2GB, because if using **read()**, it will read the entire file and use lots of the RAM.
